                ...
                <div class="span4 box">
                    <div class="content-wrap">
                        ...
                        <div class="form-group field-admin-adminuser">
                            ...
                            <?php echo $form->field($model,'adminuser')->textInput(['class'=>'span12','id'=>'admin-adminuser','placeholder'=>'管理员账号']);?>
                            </div>
                        <div class="form-group field-admin-adminpass">
                            <p class="help-block help-block-error"></p>
                            <?php echo $form->field($model,'adminpass')->passwordInput(['value'=>'', 'class'=>'span12','id'=>'admin-adminpass','placeholder'=>'管理员密码']);?>
                            </div>
